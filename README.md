...
- **Original data**: The full CSV files are deposited on Zenodo under restricted access. Researchers wishing to access the data for validation purposes may request it via Zenodo (https://doi.org/10.5281/zenodo.18266459), subject to approval.
